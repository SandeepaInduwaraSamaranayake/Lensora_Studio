package com.lensora.lensorastudio.feature.explorer.workspace;
...
public class WorkspaceDockingService
{
    ...
    public void createDefaultLayout()
    {
        ...
        if (projectsNode != null) left.addChild(projectsNode);
        if (detailsNode != null) left.addChild(detailsNode);
        ...
        if (filesNode != null) right.addChild(filesNode);
        if (metadataNode != null) right.addChild(metadataNode);
