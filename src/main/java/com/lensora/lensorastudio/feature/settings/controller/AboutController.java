package com.lensora.lensorastudio.feature.settings.controller;
...
public class AboutController implements DialogController
{
    ...
    public void initialize()
    {
        ...
        // 5. Logging (example)
        String logDir = com.lensora.lensorastudio.core.config.AppSettings.getInstance().getDefaultLogDir();
